  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <aside className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-gray-900 rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <h3 className="text-sm font-bold mb-2 relative z-10">Newsletter Bricona</h3>
      ...
      <CTASection
        ...
        description="Bricona accompagne les artisans dans leur digitalisation, automatisation et mise en relation avec les bons clients."
