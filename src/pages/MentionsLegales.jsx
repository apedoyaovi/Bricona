      ...
      <div className="px-8 pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <Section title="Directeur de Publication">
            <p>Le directeur de la publication du site est le représentant légal d'Enésense.</p>
          </Section>
          ...
          <Section title="Propriété Intellectuelle">
            <p>L'ensemble des contenus présents sur le site Enésense (structure, textes, logos, images, vidéos, etc.) est protégé par le droit d'auteur et le droit de la propriété intellectuelle.</p>
            <p>Toute reproduction, représentation, modification, publication ou adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable d'Enésense.</p>
          </Section>
