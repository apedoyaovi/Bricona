          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute -bottom-10 -left-10 glass-panel p-8 rounded-xl max-w-xs shadow-xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-on-surface">Fondation Bricona</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl lg:text-3xl font-extrabold font-headline text-on-primary mt-6 mb-4 leading-tight">Bricona digitale, un Nouveau Standard Mondial.</h2>
              <p className="text-on-primary/70 text-sm leading-relaxed mb-8">
                Dans 10 ans, chaque entreprise disposera d'un écosystème digital intelligent qui n'effacera pas son travail, mais le libérera des contraintes administratives et logistiques. Bricona construit ce socle.
              </p>
