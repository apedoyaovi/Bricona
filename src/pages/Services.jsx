        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <div className="text-sm text-primary-fixed max-w-lg mb-8 leading-relaxed">
              <p className="mb-4">
                Enésense fusionne le savoir-faire actuel des entreprises et l'innovation technologique pour propulser votre activité vers de nouveaux horizons de performance. 
