      ...
      <div className="px-8 pb-24">
        <div className="max-w-4xl mx-auto">
          <Section title="Acceptation des Conditions">
            <p>En accédant et en utilisant le site web d'Enésense, vous acceptez d'être lié par ces conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre site.</p>
          </Section>
          ...
          <Section title="Propriété Intellectuelle">
            <p>Tous les contenus présents sur ce site (textes, images, logos, design) sont la propriété exclusive d'Enésense et sont protégés par les lois sur la propriété intellectuelle.</p>
          ...
          <Section title="Responsabilités">
            <p><strong className="text-on-surface">Enésense s'engage à :</strong></p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <Section title="Limitation de Responsabilité">
            <p>Enésense ne peut être tenu responsable des dommages indirects résultant de l'utilisation de nos services ou de dysfonctionnements techniques indépendants de notre volonté.</p>
          </Section>

          <Section title="Modification des Conditions">
            <p>Enésense se réserve le droit de modifier ces conditions d'utilisation à tout moment. Les modifications entrent en vigueur dès leur publication sur le site.</p>
          </Section>
