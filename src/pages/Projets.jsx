...
const projets = [
  {
    id: 'digitalisation',
    title: 'Digitalisation Sur Mesure',
    category: 'Digitalisation',
    desc: 'Accompagnement digital et développement logiciel pour entreprises.',
    icon: 'devices',
  ...
  },
  {
    ...
    desc: 'Workflows intelligents libérant les équipes des tâches répétitives.',
  ...
  },
  {
    ...
    category: 'Software',
    desc: 'Applications métier complètes pour la gestion et la planification.',
    icon: 'terminal',
  ...
  },
  {
    ...
    category: 'Mentorat',
    desc: 'Stratégie et exécution pour transformer votre activité en marque numérique.',
    icon: 'psychology',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <h1 className="font-headline text-3xl md:text-5xl font-extrabold text-white leading-tight tracking-tight mb-4">
              L'Excellence en Action avec<br /><span className="text-secondary-container">Enésense digital</span>.
            </h1>
            <p className="text-sm text-primary-fixed max-w-lg mb-8 leading-relaxed">
              Découvrez comment Enésense a transformé des visions des entreprises en réalités numériques d'exception.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 md:px-8">
        <div className="max-w-7xl mx-auto rounded-[2.5rem] hero-gradient p-6 lg:p-10 text-center relative overflow-hidden shadow-2xl shadow-primary/20">
          ...
          <p className="text-primary-fixed text-xs max-w-2xl mx-auto mb-5 opacity-90">
            Rejoignez les entreprises qui façonnent le futur de leur métier avec Enésense.
          </p>
